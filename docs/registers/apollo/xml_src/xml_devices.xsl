...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
 ...
 <xsl:template match="ioreg" mode="index">
	 ...
	 <A id="{ioreg_name}index" href="#{ioreg_name}">
		 <B>REG_<xsl:value-of select="/device/device_name"/>_<xsl:value-of select="ioreg_name"/></B>
		 -
   ...
   <xsl:template match="ioreg" mode="bigpicture">
      <TR align="top">
         <TH align="left" bgcolor="#888888">
            <A href="#{ioreg_name}"> 
      REG_<xsl:value-of select="/device/device_name"/>_<xsl:value-of select="ioreg_name"/>
            </A>
            <BR/>
   ...
   <xsl:template match="ioreg">
      ...
      <TABLE border="1" cellpadding="3" cellspacing="0">
         <TR align="left" bgcolor="#888888">
            ...
            <TH><U><SMALL>Accessor Macro</SMALL></U></TH>
         </TR>
   ...
   <xsl:template match="ioreg_bitfield" mode="bitfield">
	...
	<TD>
           <xsl:apply-templates select="@access_macro"/>
        </TD>
     </TR>
   </xsl:template>
